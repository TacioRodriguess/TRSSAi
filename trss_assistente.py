...
CUSTOM_PROMPT = """
Você é o "TRSS Coder", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.markdown("🔗 [Meu GitHub](github.com/TacioRodriguess )")

    # Meu contato
    st.link_button("✉️ Meu e-mail para contato", "taciorodriguessantos@hotmail.com")
